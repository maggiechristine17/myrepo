...
**Brad**: So we want to start the conversation by simply trying to pin down what “[[Clippings/Correlation from Church History Topics\|Correlation from Church History Topics]]” is—is it some kind of committee, is it an administrative or editorial process, is it a mysterious, occult power, is it a state of mind?
